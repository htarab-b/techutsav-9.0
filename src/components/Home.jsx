    ...
    <>
      ...
      <div class="container"> 
        <div class="homecontent"> 
          <h1>Welcome to <strong class="highlight">Tech Utsav</strong> <br/> Where Innovation Meets Celebration!</h1>

          <h2>About Tech Utsav:</h2>
          <p>Tech Utsav, an inter-collegiate Technical Symposium, is set to ignite the sparks of innovation and celebrate the spirit of technology. Organized by two dynamic clubs, Club Inferno and Live Wires, from the prestigious SRM Institute of Science and Technology (SRMIST), this event is a convergence of brilliance, curiosity, and cutting-edge technology.</p>

          <h2>15 Events, One Extravaganza</h2>
          <p>Get ready for a tech-packed extravaganza as Tech Utsav unfolds 15 mind-boggling events that cater to a diverse range of interests and expertise. Whether you are a coding enthusiast, a robotics maestro, a cybersecurity wizard, or a design virtuoso, there's something for everyone. Explore, compete, and showcase your skills on a grand stage.</p>

          <h2>Clubs Behind the Magic</h2>
          <p>Meet the masterminds driving the Tech Utsav phenomenon - Club Inferno and Live Wires. These two powerhouse clubs from SRMIST are dedicated to fostering innovation, technical excellence, and a passion for technology. Join us in this collaborative effort to bring together the best and the brightest minds in the tech world.</p>

          <h2>Save the Dates</h2>
          <p>Mark your calendars for the ultimate tech rendezvous! Tech Utsav will take place on 26th and 27th March 2024. Be prepared to witness the unfolding of the future, where ideas turn into reality, and technology takes center stage.</p>

          <h2>Why Attend Tech Utsav?</h2>
          <p>- Networking: Connect with like-minded individuals, industry experts, and potential collaborators.</p>
          <p>- Learning: Gain insights from keynote speakers, workshops, and hands-on experiences.</p>
          <p>- Competing: Showcase your skills and compete against the best in various technical domains.</p>
          <p>- Innovation: Witness groundbreaking projects and innovations that could shape the future.</p>

          <h2>Join the Celebration</h2>
          <p>Tech Utsav is not just an event; it's a celebration of technology, innovation, and the spirit of learning. Join us in this exhilarating journey, where knowledge meets excitement and passion meets purpose.</p>

          <h3>Ready to be a part of something extraordinary? Don't miss out on Tech Utsav<br/>Reserve your spot now and embark on a tech-filled adventure!</h3>

          🚀 [Register Now] | 📧 [Contact Us] | 📱 [Follow Us on Social Media]

          Let's make Tech Utsav 2024 an experience to remember!
        </div> 
      </div> 
      </section>
    </>
