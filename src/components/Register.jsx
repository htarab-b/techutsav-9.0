...
function Register() {
    ...
    const renderForm = () => {
        switch(eventName) {
            case "technnostrom":
                return "https://docs.google.com/forms/u/0/d/e/1FAIpQLSedVvWWcnDQepo4c9Mni_i0TUyYtkwVdZYYzv3cUIZCU385oQ/formResponse";
        }
    };
    ...
    <>
      ...
      <div class="container"> 
        <div class="registercontent">
          <h1>Register for <strong class="highlight">{eventName}</strong></h1>
            <center>
                <form action={renderForm()} method="post">
                    <div class="form"> 
                        <div class="inputBox"> 
                            <input type="text" name="Name" required /> <i>Name</i> 
                        </div> 
                    <div class="inputBox"> 
                        <input type="text" name="College" required /> <i>College</i> 
                    </div> 
                    <div class="inputBox"> 
