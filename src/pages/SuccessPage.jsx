    ...
    <>
      ...
      <div className="container"> 
        <div className="homecontent">
          <h1>Your Registration for <strong className="highlight">{eventName}</strong> has been recorded successfully!</h1>
          <Link to={"../events"}><h4> See more events </h4></Link>
          <Link to={"../"}><h4> Go back to Homepage </h4></Link>
        </div> 
      </div> 
      </section>
    </>
